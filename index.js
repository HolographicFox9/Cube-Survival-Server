...
app.get("/healthz", (_req, res) => {
  res.status(200).json({ ok: true, game: "HOSTL", multiplayer: true, serverBuild: 506, gameBuild: 578, rulesVersion: "578", chat: true, googleAuth: !!GOOGLE_CLIENT_ID, ...getCubeServerStats() });
});
