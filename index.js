...
app.get("/healthz", (_req, res) => {
  res.status(200).json({ ok: true, game: "HOSTL", multiplayer: true, serverBuild: 505, gameBuild: 577, rulesVersion: "577", chat: true, ...getCubeServerStats() });
});
...
app.get("/status", (_req, res) => {
  ...
  res.status(200).json({ ok: true, ...getCubeServerStats(), maxPlayersPerRoom: 12, serverBuild: 505, gameBuild: 577 });
});
