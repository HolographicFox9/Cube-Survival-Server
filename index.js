...
app.get("/healthz", (_req, res) => {
  res.status(200).json({ ok: true, game: "HOSTL", multiplayer: true, serverBuild: 503, gameBuild: 575, rulesVersion: "575", chat: true, ...getCubeServerStats() });
});
...
app.get("/status", (_req, res) => {
  ...
  res.status(200).json({ ok: true, ...getCubeServerStats(), maxPlayersPerRoom: 12, serverBuild: 503, gameBuild: 575 });
});
